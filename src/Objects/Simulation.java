...
import static proyecto2.Main.ST;
import static proyecto2.Main.SW;
    ...
    public void operate() {
        ...
        while (true) {
            ...
            if (chosenCharacters == null) {
                ...
                battleInterface.getLevel1RS().setText(ST.getPrior1Queue().printQueue());
                battleInterface.getLevel2RS().setText(ST.getPrior2Queue().printQueue());
                battleInterface.getLevel3RS().setText(ST.getPrior3Queue().printQueue());
                battleInterface.getReinforceRS().setText(ST.getReinfQueue().printQueue());

                battleInterface.getLevel1A().setText(SW.getPrior1Queue().printQueue());
                battleInterface.getLevel2A().setText(SW.getPrior2Queue().printQueue());
                battleInterface.getLevel3A().setText(SW.getPrior3Queue().printQueue());
                battleInterface.getReinforceA().setText(SW.getReinfQueue().printQueue());
